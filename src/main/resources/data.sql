...
INSERT INTO Products (name, description, price, product_class, quantity) VALUES ('Product A', 'Product A description', 100, '食品', 10);
INSERT INTO Products (name, description, price, product_class, quantity) VALUES ('Product B', 'Product B description', 200, '嗜好品', 20);
INSERT INTO Products (name, description, price, product_class, quantity) VALUES ('Product C', 'Product C description', 300, '飲料水', 30);

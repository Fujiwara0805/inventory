...
INSERT INTO Products (name, description, price, delivery_date, product_class, supplier_name, quantity) VALUES ('Product A', 'Product A description', 100, '2023-06-01', '食品', 'Supplier A', 10);
INSERT INTO Products (name, description, price, delivery_date, product_class, supplier_name, quantity) VALUES ('Product B', 'Product B description', 200, '2023-07-01', '嗜好品','Supplier B', 20);
INSERT INTO Products (name, description, price, delivery_date, product_class, supplier_name, quantity) VALUES ('Product C', 'Product C description', 300, '2023-08-01', '飲料水','Supplier A', 30);
